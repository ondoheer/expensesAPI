...
class TestCategory(unittest.TestCase):
	...
	def test_get_expenses_with_expenses(self):
		...
		expense_representation = {'expenses': [{'amount': 10.03, 'category_id': 1, 'date': '16/02/2018', 'id': 1, 'month_id': 201821, 'name': 'Beer', 'user_id': 1}], 'has_next': False, 'has_prev': False, 'next_num': None, 'pages': 1, 'prev_num': None}
